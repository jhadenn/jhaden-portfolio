...
export default function footer() {
  ...
  disclaimer.innerHTML = `<p>Licensed under the <a href="https://www.gnu.org/licenses/agpl-3.0.html" target="_blank"Designed >AGPL-3.0-or-later</a></p><br><br><p> </p>`;
